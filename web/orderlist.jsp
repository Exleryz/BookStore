                ...
                <table cellspacing="0" class="infocontent">
                    <tr>
                        <td style="padding:20px"><p>欢迎${user.username}光临商城！</p>
                            <p>
                                您有<font style="color:#FF0000">${orderCount}</font>个订单
                            </p>
                            <table width="100%" border="0" cellspacing="0" class="tableopen">
                                ...
                                <c:forEach items="${orders}" var="order" varStatus="vs">
                                    <tr>
                                        ...
                                        <td class="tableopentd03"><a href="${pageContext.request.contextPath}/findOrderItemByOrderId?orderid=${order.id}">查看</a>&nbsp;&nbsp;
                                            <a href="#">刪除</a>
                                        </td>
                                    </tr>
                                </c:forEach>
